...
const GameLevel = ({ difficulty, initialTimerDuration, initialChances }) => {
  ...
  return (
    <div className={`${difficulty.toLowerCase()}-container`}>
      <audio id="gameStartSound" src="https://codeskulptor-demos.commondatastorage.googleapis.com/GalaxyInvaders/theme_01.mp3"></audio>
      ...
      <audio id="timeUpSound" src="https://commondatastorage.googleapis.com/codeskulptor-demos/pyman_assets/intromusic.ogg"></audio>
